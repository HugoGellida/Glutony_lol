...
void sceneMain(Scene& scene)
{
    ...
    for (size_t i = 0; i < 10; ++i)
    {
        ...
        cube->transform.setPosition(glm::vec3(i * 2.0f, 0.0f, 0.0f));
        cube->transform.setRotation(glm::vec3(0.0f, i * 15.0f, 0.0f));
        cube->transform.setScale(glm::vec3(0.1f));
        cube->addComponent(new component::MeshRenderer(mesh, mat));
        cube->addComponent(new physics::BoxCollider(glm::vec3(0.0f), glm::vec3(0.5f), glm::vec3(1.0f)));
