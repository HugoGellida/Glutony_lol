...
class ButtonWidget : public ConstrainedBoxWidget
{
public:
    ButtonWidget();
    ...
    bool isCompositeTemplate() const override;
    std::optional<std::string> primaryTextPropertyKey() const override;
    bool matchesElement(const Rml::Element& element) const override;
    std::string labelFromElement(const Rml::Element& element) const override;
